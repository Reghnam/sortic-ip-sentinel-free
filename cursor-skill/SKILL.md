...
metadata:
  short-description: "SorticAI Free IP Sentinel v0.5.27-free — screenshot-first next-paste; skills=all hop; HITL v0.5.25 zip stale; free hygiene only"
  version: "0.5.27-free"
  release: "2026-08-17"
  patched: "2026-09-16"
...
# SorticAI IP Sentinel — Free Edition (v0.5.27-free)
...
|  v0.5.27-free (portable)  ·  sorticai.com  ·  patched 2026-09-16              |
...
**Example L0 livestream attend:** "Register for the Grok Bot Galaxy livestream." / "You've been added to Grok Bot for Founders / PMs / Sales." / "Claude.ai sign-in link." / "Set AI Training crawlers to Disallow." → L0 silent. Attending / calendar add / magic-link / crawler toggles are not an IP moment. Invite copy that each Bot has its own computer is marketing.
...
- Version in header: v0.5.27-free.
...
- Current version: **v0.5.27-free** (patched 2026-09-16; first released 2026-08-17). Description ≤1024. Body stays well under 500 lines. Claude YAML stays name+description only.
