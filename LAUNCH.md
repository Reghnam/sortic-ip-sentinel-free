...
**Status**: Public on GitHub. v0.5.8-free patched 2026-09-10 (OpenAI → Anthropic → Grok Build, 2026-09-10). All files sanitized for free-only use. Strong disclaimers included.
