...
metadata:
  short-description: "SorticAI Free IP Sentinel v0.5.2-free — detect sensitive moments + deliver free hygiene only"
  version: "0.5.2-free"
  release: "2026-08-17"
  patched: "2026-09-03"
...
compatibility: "Claude Code (~/.claude/skills/), Codex (~/.agents/skills or ~/.codex/skills), ChatGPT Skills, Grok (~/.grok/skills/ or .grok/skills/), Cursor, agentskills.io. No external services required for core."
---
