...
description: >
  ...
  de-identified training, ZDR, Astra computer-use, App Builder preview, claude.ai sync, or when a headless/Grok Bot/computer-use/subagent
  will show, email, push, post, auto-publish, send leftover drafts, protected-lane, Bot-to-Bot, desktop-egress, ownership-pass, or treat a backup as publish.
...
metadata:
  short-description: "SorticAI Free IP Sentinel v0.5.15-free — desktop-egress CDN, ownership-pass, videos 48h+30d; free hygiene only"
  version: "0.5.15-free"
  release: "2026-08-17"
  patched: "2026-09-14"
...
# SorticAI IP Sentinel — Free Edition (v0.5.15-free)
...
|  v0.5.15-free (portable)  ·  sorticai.com  ·  patched 2026-09-14              |
...
- **De-identified training is still a disclosure.** Frontier chat of invention-grade content is L2 without protect language, L3 with it — even if ZDR / Business / Enterprise / "we don't train" / PII-stripped is claimed. Opt-out is not a rewind. A public clip about the industry issue is L0. **API no-train ≠ ChatGPT no-train** (API opt-in only since 2023; consumer/Business chat is a different lane). **ZDR-ineligible** even when the org has ZDR: conversations+items, agents, files, vector stores, evals, assistants, threads+messages/runs/steps, chatkit, batches, videos (48h+30d; blocked for MAM/ZDR; Eyes Off still retain), fine-tuning. Hosted container discarded ≠ abuse-monitor 30d gone. Anthropic: **Skills are not covered by ZDR** — skill definitions *and* execution data are retained. Covered-model safety retention (30 days) can apply even on ZDR orgs. **Protected-lane check** (hygiene, not a product): map consumer chat vs API / local / open-source; do not claim a plan is the protected lane.
...
- Version in header: v0.5.15-free.
...
- Current version: **v0.5.15-free** (patched 2026-09-14; first released 2026-08-17). Description ≤1024. Body stays well under 500 lines.
