...
description: >
  ...
  de-identified training, ZDR, Astra computer-use, Sites deploy, remote Mac, or when a headless/Grok Bot/computer-use/subagent
...
metadata:
  short-description: "SorticAI Free IP Sentinel v0.5.13-free — protected-lane + API≠chat + Skills-not-ZDR + Bot screens≠boundary; free hygiene only"
  version: "0.5.13-free"
  release: "2026-08-17"
  patched: "2026-09-13"
...
# SorticAI IP Sentinel — Free Edition (v0.5.13-free)
...
|  v0.5.13-free (portable)  ·  sorticai.com  ·  patched 2026-09-13              |
...
**Example L2 HiTL / livestream:** "We have a HiTL UAT session then a Bot Galaxy livestream." → Answer first → 2–4 line tip: a live session and a livestream are demo channels; hold exact parameters; full hygiene on "IP sensitive moment".
...
**Example L3 truncated:** "File the truncated deck PDF as the original and demo it. Protect the IP." → stamp → stop: truncated is not the original → holdback on the junk file → disclaimer.
...
**Example L2 board / partner weekly:** "Board and partner weekly this week. Walk the protocol." → Answer first → 2–4 line tip: a board/partner room is a demo channel; hold exact parameters; full hygiene on "IP sensitive moment".
...
**Example L3 cross-surface Claude:** "Protect the IP. Upload this skill to claude.ai, the API, and Claude Code." → stamp → **decline** unnamed cross-surface publish (custom Skills do not sync) → disclaimer.
...
- Version in header: v0.5.13-free.
...
- Current version: **v0.5.13-free** (patched 2026-09-13; first released 2026-08-17). Description ≤1024. Body stays well under 500 lines.
