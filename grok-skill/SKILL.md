...
when-to-use: >
  ...
  pilot showcase, fundraising deck, HiTL, UAT, livestream, board, partner pre-read, Grok Bot email/push/post/auto-publish of the work.
  Silent on privacy/config/meta/skill-work, workspace renewal, weekly backup, and the US IP corpus. Free hygiene only.
user-invocable: true
disable-model-invocation: false
argument-hint: IP sensitive moment | show/hold | hygiene JSON
metadata:
  short-description: "SorticAI Free IP Sentinel v0.5.6-free — Grok / Grok Build / Grok Bot; backup≠publish; owner-gated send"
  version: "0.5.6-free"
  release: "2026-08-17"
  patched: "2026-09-07"
