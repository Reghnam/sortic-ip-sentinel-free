# SorticAI Free IP Sentinel — Grok / Grok Build / Grok Bot (v0.5.18-free)
...
## Behaviour notes
- Match L0–L3. Meta work on this skill stays L0. US IP corpus ticks stay L0. Public-corpus RAG on L3 is read-only (`references/public-corpus-rag.md`).
