# SorticAI Free IP Sentinel — ChatGPT / Codex (v0.5.2-free)
...
Invoke: `$sortic-ip-sentinel-free` or `/skills`. Implicit match uses the description (front-loaded triggers). Headless `-p`: unnamed L3 **default-delivers 1 (show/hold) + 8 (JSON)**; or add "Output numbered options and hygiene package JSON."
...
- No MCP tool dependencies. Core hygiene is self-contained.
