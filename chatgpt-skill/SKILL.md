...
- OpenAI 2026: description is the match rule (front-load triggers; list may truncate to 8k / 2% context). `allow_implicit_invocation: true`. No MCP dependencies. Prefer instructions over scripts. Zip with SKILL.md at zip root for ChatGPT Skills.
