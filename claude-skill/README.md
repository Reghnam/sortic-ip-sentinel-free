# SorticAI Free IP Sentinel — Claude Code (v0.5.11-free)

Anthropic-strict package. SKILL.md YAML is **only** `name` + `description` (required). Name is kebab-case, ≤64 chars. Description is 1022 chars (limit 1024), includes what + when + do-not-use + Bot/computer-use / Astra, no XML.
