# SorticAI Free IP Sentinel — Claude Code (v0.5.6-free)

Anthropic-strict package. SKILL.md YAML is **only** `name` + `description` (required). Name is kebab-case, ≤64 chars. Description is 952 chars (limit 1024), includes what + when + do-not-use + Bot/computer-use, no XML.

`references/` is **bundled**. One copy is a complete skill. Evals: `references/evals.md` (13; ≥3 required). Degrees of freedom: low on send/publish/pay/login.
...
- SKILL.md well under the 500-line body guidance (~353 lines).
