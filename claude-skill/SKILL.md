...
- Keep this SKILL.md under 500 lines. References stay one level deep. Prefer instructions over scripts. Provide a default (headless 1+8). ≥3 evals in `references/evals.md`.
